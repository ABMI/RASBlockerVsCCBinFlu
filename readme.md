...
2. In `R`, use the following `devtools` command to install the RASBlockerVsCCBinFlu package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/RASBlockerVsCCBinFlu"
...
License
=======
The RASBlockerVsCCBinFlu package is licensed under Apache License 2.0

Development
===========
RASBlockerVsCCBinFlu was developed in ATLAS and R Studio.
